...
// ../../../../../workspace/阿塞/yiqiba.app/node_modules/weapp-cookie/dist/weapp-cookie.umd.js
var require_weapp_cookie_umd = __commonJS({
  "../../../../../workspace/\u963F\u585E/yiqiba.app/node_modules/weapp-cookie/dist/weapp-cookie.umd.js"(exports, module) {
    ...
    (function(d, f) {
      ...
      class _ {
        constructor(e) {
          this.name = e.name || "", this.value = e.value || "", this.domain = e.domain || "", this.path = e.path || "/", this.expires = e.expires ? new Date(e.expires) : null, this.maxAge = e.maxAge !== void 0 && e.maxAge !== null ? parseInt(e.maxAge) : null, this.httpOnly = !!e.httpOnly, this.dateTime = e.dateTime ? new Date(e.dateTime) : new Date();
        }
        set(e = "") {
        ...
        isExpired() {
          return this.maxAge === 0 ? true : this.maxAge > 0 ? (Date.now() - this.dateTime.getTime()) / 1e3 > this.maxAge : !!(this.expires && this.expires < new Date());
        }
        isPersistence() {
...
init_define_process_env_UNI_STAT_TITLE_JSON();
init_define_process_env_UNI_STAT_UNI_CLOUD();
var weapp_cookie_default = require_weapp_cookie_umd();
export {
  weapp_cookie_default as default
};
